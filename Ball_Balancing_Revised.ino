...
TouchScreen ts = TouchScreen(A0, A1, A2, A3, 0);  //touch screen pins (Y-, X-, Y+, X+)
...
double Xoffset = 475;  //X offset for the center position of the touchpad
double Yoffset = 525;  //Y offset for the center position of the touchpad
